...
{
    public partial class AddTblArtikalComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            tblartikal = new Bssr.Models.Bssr4.TblArtikal(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Bssr.Models.Bssr4.TblArtikal args)
        {
            try
            {
                var bssr4CreateTblArtikalResult = await Bssr4.CreateTblArtikal(tblartikal);
                DialogService.Close(tblartikal);
            }
            catch (System.Exception bssr4CreateTblArtikalException)
            {
                NotificationService.Notify(NotificationSeverity.Error, $"Error", $"Unable to create new TblArtikal!");
            }
        }
