...
{
    public partial class AddTblNalogStavkiComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            tblnalogstavki = new Bssr.Models.Bssr4.TblNalogStavki(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Bssr.Models.Bssr4.TblNalogStavki args)
        {
            try
            {
                var bssr4CreateTblNalogStavkiResult = await Bssr4.CreateTblNalogStavki(tblnalogstavki);
                DialogService.Close(tblnalogstavki);
            }
            catch (System.Exception bssr4CreateTblNalogStavkiException)
            {
                NotificationService.Notify(NotificationSeverity.Error, $"Error", $"Unable to create new TblNalogStavki!");
            }
        }
