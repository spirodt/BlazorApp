...
{
    public partial class AddTblIzvodiStavkiComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            tblizvodistavki = new Bssr.Models.Bssr4.TblIzvodiStavki(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Bssr.Models.Bssr4.TblIzvodiStavki args)
        {
            try
            {
                var bssr4CreateTblIzvodiStavkiResult = await Bssr4.CreateTblIzvodiStavki(tblizvodistavki);
                DialogService.Close(tblizvodistavki);
            }
            catch (System.Exception bssr4CreateTblIzvodiStavkiException)
            {
                NotificationService.Notify(NotificationSeverity.Error, $"Error", $"Unable to create new TblIzvodiStavki!");
            }
        }
